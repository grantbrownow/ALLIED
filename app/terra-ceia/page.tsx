...
export default function TerraCeiaPage() {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative bg-zinc-900 text-white py-20">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              alt="Terra Ceia Demolition Services"
              fill
          ...
          <div className="container relative z-10">
            <div className="max-w-4xl">
              <h1 className="text-4xl font-bold tracking-tight md:text-6xl mb-6">
                Best Demolition Service in Terra Ceia
              </h1>
              <p className="text-xl md:text-2xl mb-8">
                Terra Ceia's trusted demolition contractor with 15+ years of experience serving the greater Terra Ceia area
              </p>
        ...
        {/* Why Choose ALLIED Wrecking in Terra Ceia */}
        <section className="py-20 bg-white">
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4 font-heading">Why Choose ALLIED Wrecking in Terra Ceia?</h2>
              <div className="w-20 h-1 bg-primary mx-auto rounded-full mb-6"></div>
              <p className="text-lg text-zinc-600 max-w-3xl mx-auto">
                As Terra Ceia's premier demolition contractor, we bring unmatched expertise, local knowledge, and 
                commitment to excellence to every project in the Terra Ceia area.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="text-center p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-zinc-600">
                    Decades of expertise serving Terra Ceia and surrounding communities with reliable demolition services.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <CardHeader className="pb-4">
                  ...
                  <CardTitle className="text-xl">Local Terra Ceia Service</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-zinc-600">
                    Based in Tampa with deep understanding of Terra Ceia regulations, permits, and community needs.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-zinc-600">
                    Fully licensed and insured for your peace of mind on every Terra Ceia demolition project.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-zinc-600">
                    Available around the clock for emergency demolition needs throughout Terra Ceia and surrounding areas.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        {/* Terra Ceia Demolition Services */}
        <section className="py-20 bg-gray-50">
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4 font-heading">Complete Demolition Services in Terra Ceia</h2>
              <div className="w-20 h-1 bg-primary mx-auto rounded-full mb-6"></div>
              <p className="text-lg text-zinc-600 max-w-3xl mx-auto">
                From residential homes to commercial buildings, we provide comprehensive demolition solutions 
                throughout the Terra Ceia area.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-zinc-600 mb-4">
                  Complete home demolition, pool removal, and site preparation for Terra Ceia homeowners.
                </p>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-zinc-600 mb-4">
                  Large-scale commercial and industrial demolition projects throughout Terra Ceia.
                </p>
                <ul className="space-y-2 text-sm text-zinc-600">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-zinc-600 mb-4">
                  Precise interior and partial demolition for renovation projects in Terra Ceia.
                </p>
                <ul className="space-y-2 text-sm text-zinc-600">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-zinc-600 mb-4">
                  Professional cleanup and debris removal services throughout Terra Ceia.
                </p>
                <ul className="space-y-2 text-sm text-zinc-600">
        ...
        {/* Terra Ceia Service Areas */}
        <section className="py-20 bg-white">
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4 font-heading">Serving Terra Ceia & Surrounding Areas</h2>
              <div className="w-20 h-1 bg-primary mx-auto rounded-full mb-6"></div>
              <p className="text-lg text-zinc-600 max-w-3xl mx-auto">
                From downtown Terra Ceia to the surrounding communities, we provide demolition services throughout 
                the entire Terra Ceia metropolitan area.
              </p>
            </div>
        ...
        {/* Terra Ceia Demolition Process */}
        <section className="py-20 bg-gray-50">
          <div className="container">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4 font-heading">Our Terra Ceia Demolition Process</h2>
              <div className="w-20 h-1 bg-primary mx-auto rounded-full mb-6"></div>
              <p className="text-lg text-zinc-600 max-w-3xl mx-auto">
                We follow a proven, systematic approach to ensure every Terra Ceia demolition project is completed 
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">
                    We visit your Terra Ceia property to assess the scope of work, identify potential challenges, 
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">
                    Our team handles all necessary Terra Ceia demolition permits and ensures compliance with 
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">
                    ...
                    measures to protect your property and surrounding areas in Terra Ceia.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">
                    ...
                    while maintaining safety standards and minimizing disruption to your Terra Ceia neighborhood.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">
                    ...
                    properly disposing of waste in accordance with Terra Ceia's environmental regulations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-zinc-600">
                    ...
                    new construction, landscaping, or other development in Terra Ceia.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Terra Ceia Demolition Permits */}
        <section className="py-20 bg-white">
          <div className="container">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-4xl font-bold mb-4 font-heading">Terra Ceia Demolition Permits & Regulations</h2>
                <div className="w-20 h-1 bg-primary mx-auto rounded-full mb-6"></div>
                <p className="text-lg text-zinc-600">
                  Understanding Terra Ceia's demolition permit requirements is crucial for a successful project. 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gray-50 p-8 rounded-xl">
                  <h3 className="text-xl font-bold mb-4">Required Permits in Terra Ceia</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                      <span>Demolition permit from Manatee County</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                ...
                <div className="bg-gray-50 p-8 rounded-xl">
                  <h3 className="text-xl font-bold mb-4">Terra Ceia-Specific Requirements</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                      <span>Manatee County building codes</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
                      <span>Rural area considerations</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-primary shrink-0 mt-0.5" />
        ...
        <section className="py-20 bg-secondary text-white relative overflow-hidden">
          ...
          <div className="container relative z-10 text-center">
            <h2 className="text-4xl font-bold mb-6 font-heading">
              Ready to Start Your Terra Ceia Demolition Project?
            </h2>
            <div className="w-20 h-1 bg-primary mx-auto rounded-full mb-6"></div>
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Contact Terra Ceia's trusted demolition contractor for a free consultation and quote on your project.
            </p>
